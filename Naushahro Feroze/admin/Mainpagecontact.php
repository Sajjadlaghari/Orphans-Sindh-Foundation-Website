           ...
           <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="color:#13b086; text-align:center; text-transform:uppercase;">Main Home Page Contact Messages</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    $sql="select * from contactmessageformainhomepage";
                                  ...
                                  ?>
                                       ...
                                       <tr>
                                           ...
                                           <td><?php echo "<a href='deletecontactmessageformainhomepage.php?id=".$row['S_No']."' class='btn btn-danger text-white'><i class='fa fa-trash' aria-hidden='true'></i></a>"?></td>
