...
if(isset($_POST['set']))
{
    ...
    $e = $_SESSION['e'];
     ...
     $sql="UPDATE adminnf SET user_password='$p' where user_email='$e'";
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" name="cpassword" type="password" placeholder="*********" />
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0 offset-4">
                                                    <input type="submit" name="set" Value="Set New Password" class="btn btn-info text-white">
                                           </div>
                                        </form>
                                    </div>
                                </div>
