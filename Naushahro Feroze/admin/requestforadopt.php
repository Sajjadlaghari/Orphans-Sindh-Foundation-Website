...
<html lang="en">
    <head>
        ...
        <title>View Request for Adopt Child</title>
           ...
           <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="color:#13b086; text-align:center; text-transform:uppercase;">Requests for Adopt Child </h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                if(isset($_SESSION['deletere']))
                                {
                                    echo $_SESSION['deletere'];
                                    unset($_SESSION['deletere']);
                             
                                }
                                ?>
                                Request For Adobpt Child Details
                            </div>
                            <div class="card-body">
                                ...
                                <thead>
                                    ...
                                    $sql="select * from resquestforadoptchild";
                                  ...
                                  ?>
                                       ...
                                       <tr>
                                           ...
                                           <td><?php echo "<a href='deleteadoptrequest.php?id=".$row['S_No']."' class='btn btn-danger text-white'><i class='fa fa-trash' aria-hidden='true'></a>"?></td>
