           ...
           <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style="color:#13b086; text-align:center; text-transform:uppercase;">Donner Details</h1>
                    
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                <?php 
                                 if(isset( $_SESSION['deletedoner']))
                                  {      
                                      echo  $_SESSION['deletedoner'];
                                      unset( $_SESSION['deletedoner']);
                                    } 
                                ?>
                                Doner Details
                            </div>
                            <div class="card-body">
                                ...
                                <thead>
                                        ...
                                        <th>Sno..</th>
                                            <th>Donner_name</th>
                                            <th>Donner_email</th>
                                            <th>Donner_contact</th>
                                            <th>Donner_address</th>
                                            <th>Donner_city</th>
                                            <th>Donner_state</th>
                                            <th>Monthly/One Time</th>
                                            <th>Donner_country</th>
                                            <th>Donner_message</th>
                                            <th>Amount Rs</th>
                                            <th>Amount_for</th>
                                            <th>Payvia</th>
                                            <th>Where From Hear About Us</th>
                                            <th>Time</th>
                                            <th>Delete</th>
                                        </tr>
                                    </thead>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['Doner_Contact_No']?></td>
                                            <td><?php echo $row['Doner_Address']?></td>
                                            <td><?php echo $row['Done_City']?></td>
                                            <td><?php echo $row['Doner_State']?></td>
                                            <td><?php echo $row['Monthly_One_Time']?></td>
                                            <td><?php echo $row['Doner_Country']?></td>
                                            <td><?php echo $row['Doner_Message']?></td>
                                            <td><?php echo $row['Amount']?></td>
                                            <td><?php echo $row['Amount_For']?></td>
                                            <td><?php echo $row['Pay_via']?></td>
                                            <td><?php echo $row['Where_From_Hear']?></td>
                                            <td><?php echo date('F jS Y',strtotime($row['Time'])) ?></td>
                                            <td><?php echo "<a href='deletedonerdetails.php?id=".$row['S_No']."' class='btn btn-danger text-white'><i class='fa fa-trash' aria-hidden='true'></a>"?></td>
