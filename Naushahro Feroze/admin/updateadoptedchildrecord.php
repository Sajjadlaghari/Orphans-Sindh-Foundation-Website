...
<html lang="en">
    <head>
        ...
        <title>Update Adopted child Data</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
           ...
           if(isset($_GET['id']))
           {
             ...
             if(is_numeric($id))
             {
              $sql="select * from adopted_child_record where id=".$id;
...
<?php
        if(isset($_POST['update']))    
        {
          ...
          $sql="UPDATE adopted_child_record SET Child_name='$child_name',Child_cnic='$child_cnic_B_form',Adopter_name='$adopter_name',Adopter_cnic='$adopter_cnic',Contact_no='$adopter_contact',Present_address='$adopter_present_address',Permanent_address='$adopter_permanent_address',Job_details='$adopter_job' WHERE id=".$id;
...
<div class="container" >
    <div class="col-md-10 ">
      <div class="heading">
        <h2 class="text-center" style="margin-top:3%; margin-left:22%; font-family:sans; font-size:55px; padding-botton:20px;">Update Adopted Child Record </h2> 
        ...
        <form  style="margin-left:2%; padding:20px;"    method="post" action="">
          <div class="row  wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <label for="">Child CNIC/B_Form</label>
              <div class="form-group">
                <input type="text" name="child_cnic_b_form" value="<?php echo $row['Child_cnic']?>" class="form-control" placeholder="Enter Child CNIC/B-form" required="required">
              </div>
            </div>
          </div>  
          ...
          <div class="form-group">
            ...
            <input type="text" id="adoptername" name="adopter_name" value="<?php echo $row['Adopter_name']?>" class="form-control" placeholder="Enter Adopter Name" required="required"><br>
          </div>

          
          <div class="form-group">
              <label for="">Adopter CNIC</label>
            <input type="text" id="adopter_cnic" name="adopter_cnic" value="<?php echo $row['Adopter_cnic']?>" class="form-control" placeholder="Enter Adopter CNIC Number" required="required"><br>
          </div>

          <div class="form-group">
              <label for="">Contact No</label>
            <input type="text" id="adopter_cnic" name="adopter_contact" value="<?php echo $row['Contact_no']?>" class="form-control" placeholder="Enter Adopter Contact Number" required="required"><br>
          </div>

          <div class="form-group">
              <label for="">Adopter Present Address</label>
            <input type="text" id="adopter_present_address" name="adopter_present_address" value="<?php echo $row['Present_address']?>" class="form-control" placeholder="Present Address " required="required"><br>
          </div>

          
          <div class="form-group">
              <label for="">Adopter Permanent Address</label>
            <input type="text" id="adopter_permanent_address" name="adopter_permanent_address" value="<?php echo $row['Permanent_address']?>" class="form-control" placeholder="Permanent Address" required="required"><br>
          </div>
          <div class="form-group">
              <label for="">Adopter Job</label>
            <input type="text" id="adopter_job" name="adopter_job" value="<?php echo $row['Job_details']?>" class="form-control" placeholder="Adopter Job Details" required="required"><br>
          </div>

          <div class="form-group " >
             <input type="submit" class="col-md-5 offset-3 btn btn-primary" name="update" style="margin-bottom:20px;margin-top:20px;" value="UPDATE ADOPTED CHILD DATA" class="btn btn-primary">  
        </div>    
    </form>
      </div>
    </div>
